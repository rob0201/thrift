 ...
 * Time: 下午4:46
 */
public class AsyncHelloServerDemo {

  public static void main(String[] args) {
      AsyncHelloServerDemo serverDemo = new AsyncHelloServerDemo();
      serverDemo.startServer();
  }

  public void startServer(){
    try {
      TNonblockingServerTransport transport = new TNonblockingServerSocket(10005);
